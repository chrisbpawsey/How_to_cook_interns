...
On Magnus, jobs run on the back-end of the system with the help of SLURM and ALPS $
...
As mentioned previously, the focus of the getexample tool was not only to provide $

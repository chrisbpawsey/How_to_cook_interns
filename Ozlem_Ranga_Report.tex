...
This brings our a challenge of having to modify the example to suit their requirements on a particular computing resource (HPC). 
...
4) Different compiler flags for varying compiler options
5) 

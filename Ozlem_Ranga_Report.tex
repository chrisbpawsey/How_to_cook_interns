...
having to modify them. However, this is not always the case as some of the supercomputers in Pawsey Supercomputing Centre such as Zythos require the 
account name which is customized for each user and without the correct account name in the SLURM, the code fails to run. Therefore, it is very important 
that the users are informed on how to change their account name located in the SLURM file.       

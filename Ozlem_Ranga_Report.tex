...
For both Magnus and Zeus on 2 nodes, a total of 48 MPI tasks could be run on Magnus whereas 
this was too much for Zeus and hence the number of MPI tasks was reduced to 32.

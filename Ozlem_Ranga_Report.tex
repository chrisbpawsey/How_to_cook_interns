...
\author{\IEEEauthorblockN{RanganaiMapondera}
\IEEEauthorblockA{PawseySupercomputingCentre\\
CurtinUniversity\\
Perth,Australia\\
Email:ranganai.mapondera@student.curtin.edu.au}
\and
\IEEEauthorblockN{OzlemErkilic}\IEEEauthorblockA{PawseySupercomputingCentre\\
CurtinUniversity\\
Perth,Australia\\
...
The main aim of the "getexample" is to provide easy access to the examples for the users. The getexample tool is expected to be have the following aims
to meet th:
...
all the examples one by one and having to fix these problems. Therefore,   

...
scratch, the output file is then moved to the results directory located in the group directory. The scratch directory then gets removed.
...
a set of instruction on how to submit the SLURM to the supercomputers including which commands to use to submit the task to the specific supercomputers.
